...
CREATE TABLE Genre (
    GenreID INT AUTO_INCREMENT(1,1) PRIMARY KEY,
    GenreName VARCHAR(30) NOT NULL
);

CREATE TABLE Director (
    DirectorID INT AUTO_INCREMENT(1,1) PRIMARY KEY,
...
CREATE TABLE Rating (
    RatingID INT AUTO_INCREMENT(1,1) PRIMARY KEY,
    RatingName VARCHAR(5) NOT NULL
);

CREATE TABLE Actor  (
    ActorID INT AUTO_INCREMENT(1,1) PRIMARY KEY,
    FirstName VARCHAR(30) NOT NULL,
    LastName VARCHAR(30) NOT NULL, 
    BirthDate DATE NOT NULL
);
...
CREATE TABLE Movie (
    MovieID INT AUTO_INCREMENT(1,1) PRIMARY KEY,
...
CREATE TABLE CastMembers (
    CastMemberID INT AUTO_INCREMENT(1,1) PRIMARY KEY,
